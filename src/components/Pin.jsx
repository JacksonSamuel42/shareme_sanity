  ...
  return (
    <div className="m-2">
        ...
        >
          ...
          {postHovered && (
            <div
              className='absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 mt-2 mb-2 z-50'
              style={{height: '100%'}}
            >
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <a 
                    ...
                    className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-node"
                  >
